...
namespace Components.ProceduralGeneration
{
    ...
    {
        [Header("Generation")] 
        [SerializeField] protected int _maxSteps = 10;
        ...
        [NonSerialized] CancellationTokenSource _cancellationTokenSource;

        [Header("Room Parameters")]
        [SerializeField] protected int _maxRooms = 10;
        [SerializeField] protected Vector2Int _roomMinSize = new(5, 5);
        [SerializeField] protected Vector2Int _roomMaxSize = new(12, 8);
        ...
        protected bool CanPlaceRoom(RectInt room, int spacing)
        {
            ...
            int yMax = Mathf.Min(room.yMax + spacing, Grid.Length);
