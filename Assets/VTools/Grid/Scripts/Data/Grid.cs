...
namespace VTools.Grid
{
    public class Grid
    {
        ...
        public int Length { get; } //y
        public IReadOnlyList<Cell> Cells => _cells;

        // ------------------------------------------------------------------------- CONSTRUCTOR -------------------------------------------------------------------------
        public Grid(int width, int length, float cellSize, Vector3 originPosition, bool showDebug)
        {
            Width = width;
            Length = length;
            CellSize = cellSize;
            ...
            _gridArray = new Cell[width, length];
        ...
        public void DrawGridDebug()
        {
            ...
            {
                debugTextArray[index] = new TextMesh[Length];
            }
            ...
            Debug.DrawLine(GetWorldPosition(0, Length), GetWorldPosition(Width, Length), Color.white, float.PositiveInfinity);
            Debug.DrawLine(GetWorldPosition(Width, 0), GetWorldPosition(Width, Length), Color.white, float.PositiveInfinity);
        }
    }
}